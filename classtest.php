<?php
    ...
    {   
        ...
        if($type == $film['genres'][0])
        {
            ...
            echo 'Stars : '.$film['stars'][0].' ('. str_replace(' ','-',$film['stars'][0]).')<br/>';
        ...
        else if($type == $film['genres'][1])
        {
            ...
            echo 'Stars : '.$film['stars'][1].' ('.  str_replace(' ','-',$film['stars'][1]).')<br/>';
        ...
        else if($type == $film['genres'][2])
        {
            ...
            echo 'Stars : '.$film['stars'][2].' ('.  str_replace(' ','-',$film['stars'][2]).')<br/>';
        ...
        else if($type == $film['genres'][3])
        {
            ...
            echo 'Stars : '.$film['stars'][3].' ('.  str_replace(' ','-',$film['stars'][3]).')<br/>';
